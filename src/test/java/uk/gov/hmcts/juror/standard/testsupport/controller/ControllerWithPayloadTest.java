...
public abstract class ControllerWithPayloadTest extends ControllerTest {
    ...
    @Test
    protected void negativeInvalidContentType() throws Exception {
        callAndValidate(
    ...
    @Test
    protected void negativeMissingContentType() throws Exception {
        callAndValidate(
            new ErrorRequestArgument(HttpStatus.UNSUPPORTED_MEDIA_TYPE, getTypicalPayload(), "INVALID_CONTENT_TYPE",
    ...
    protected void positiveValidTypical(SuccessRequestArgument requestArgument) throws Exception {
